...
import { BookOpen, CheckCircle, Clock, PlayCircle, ShieldCheck, Sparkles, UserCheck } from 'lucide-react';
...
export default function StudentPortal() {
        ...
        const unsubscribeDoc = onSnapshot(userRef, (snap) => {
          if (snap.exists()) {
            ...
            setUserData({
              ...
              enrolledCourses: ['cfa-financial-master']
            });
          }
        });
  ...
  const enrolledCourseIds = userData?.enrolledCourses || ['cfa-financial-master'];
      ...
      {activeTab === 'my-courses' && (
        <div className="p-8 md:p-10 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Curso Principal: CFA Financial Master */}
            <div className="bg-[#131313] border border-gray-800 rounded-2xl overflow-hidden flex flex-col shadow-xl hover:border-[#e9c349]/40 transition-all">
              <div className="h-44 overflow-hidden relative">
                <img
                  src="https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?auto=format&fit=crop&q=80&w=800"
                  alt="A Mentalidade do Operador Institucional"
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <p className="text-xs text-gray-400 mb-4 line-clamp-2 leading-relaxed">
                  Aprenda como grandes bancos operam no mercado financeiro global e gerencie seu capital com precisão.
                </p>
                ...
                <div className="mt-auto space-y-4 pt-2">
                  ...
                  <button
                    id="btn-access-lessons-cfa"
                    onClick={() => setPlayingCourseId('cfa-financial-master')}
          ...
          <div className="bg-[#131313] border border-gray-800 rounded-2xl p-6 md:p-8 shadow-xl space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="bg-black/50 border border-gray-800 p-4 rounded-xl">
                <span className="text-[10px] text-gray-500 uppercase font-bold tracking-wider">Cursos Ativos</span>
